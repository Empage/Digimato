...
LEDs\footnote{LED Spexx TODO} verwendet. Die LEDs haben einen Abstand von $45mm$ 
TODO und werden durch ein Gitter aus Sperrholz voneinander getrennt, so dass
Pixel entstehen. Durch das Multiplexen der Zeilen kann jede LED unabhänig
gesteuert werden.

Die Anoden der Reihen jeweils verbunden und mit den Schiebregistern TODO REF
verbunden. Die Kathoden sind Zeilen verbunden und über die Mosfets vom
...
\captionof{figure}{LED Matrix Schaltplan}
\end{center}
